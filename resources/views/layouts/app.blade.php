        ...
        <nav class="nav">
            <div> 
                <a href="#" class="nav_logo"> 
                    ...
                    <span class="nav_logo-name">MercadoBom</span> 
                </a>
                <div class="nav_list"> 
                    <a href="#" class="nav_link active">
                         <i class='bx bx-grid-alt nav_icon'></i> 
                         <span class="nav_name">PainelAdmin</span> 
                        </a> 
                        ...
                        <a href="#" class="nav_link"> <i class='bx bx-globe nav_icon'>
                        </i> 
                    ...
                    <span class="nav_name">Financeiro</span> </a> 
                </div>
